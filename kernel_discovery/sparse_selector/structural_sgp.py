...
from kernel_discovery.sparse_selector.base_model import BaseSparseSelector
...
class StructuralSVGP(BayesianModel, ExternalDataTrainingLossMixin):
    ...
    def predict_f(self, Xnew: InputData, full_cov=False, full_output_cov=False) -> MeanAndVariance:
        ...
        for i, gp in enumerate(self.gps):
            w_i = w[i]
            # TODO: try catch this if there is any error. Set to zero mean and covariance. or zero weight. automatic differentiation
